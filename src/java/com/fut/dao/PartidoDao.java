...
public class PartidoDao{
   ...
   public List<Partido> listarJoin(int idGrupo){
    ...
    public List<Partido> listarPartidosPlayOff(int idPlay){
            ...
            try{
                cx = DaoUtil.ConectionDriveDB();
                stmt = cx.prepareCall(SqlAdminFutSal.SELECT_PARTIDOS_PLAYOFF);
    ...
    public List<Partido> listarPartidosPlayOffJor(int idPlay){
        //lista los partidos del play off que no esten en una jornada
            ...
            try{
                cx = DaoUtil.ConectionDriveDB();
                stmt = cx.prepareCall(SqlAdminFutSal.SELECT_PARTIDOS_PLAYOFF_JOR);
                stmt.setInt(1, idPlay);
                rs = stmt.executeQuery();
                lista = new ArrayList();
   ...
   public List<Partido> listarPartidosGrupoJor(int idGrupo){
       //lista los partidos seleccionando el grupo, para agregar el partido a una fecha. si el partido tiene idjornada null
            ...
            try{
                cx = DaoUtil.ConectionDriveDB();
                stmt = cx.prepareCall(SqlAdminFutSal.SELECT_PARTIDOS_GRUPO_JOR);
                stmt.setInt(1, idGrupo);
                rs = stmt.executeQuery();
                lista = new ArrayList();
   ...
   public List<Partido> listarPartidosJornada(Jornada jor){
            ...
            try{
                cx = DaoUtil.ConectionDriveDB();
                stmt = cx.prepareCall(SqlAdminFutSal.SELECT_PARTIDOS_JORNADA);
    ...
    public Partido leerID(int idPartido) {
        Partido usus = null;
            ...
            try{
                cx = DaoUtil.ConectionDriveDB();
                stmt = cx.prepareStatement("SELECT \"idPartido\",\"idEquipoA\",\"idEquipoB\",\"golA\",\"golB\",\"idGrupo\" FROM public.partido WHERE \"idPartido\" = ?");
    ...
    public List<TablaEquipos> listarTablaPosicionesJava(Grupo grup) {
        ...
        EquipoDao equipoDao = new EquipoDao();
            ...
            try{
                ...
                stmt = cx.prepareCall(SqlAdminFutSal.LIST_POSITION_TEAM);
    ...
    public void modificar(Partido cam){
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement("UPDATE partido SET idEquipoA = ?,idEquipoB = ?,golA = ?,golB = ?,idGrupo = ? WHERE idPartido = ?");
    ...
    public boolean agregarPartidoJornada(Jornada jornada, int idPartido, Date hora) {
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement(SqlAdminFutSal.ADD_MATCH_TO_JORNADA);
            int count = 1;
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement(SqlAdminFutSal.FINISH_PENALTIES);           
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement(SqlAdminFutSal.START_MATCH);                        
    ...
    public boolean quitarPartidoJornada(Partido par){
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement(SqlAdminFutSal.REMOVE_MATCH_FIXTURE);
     ...
     public boolean agregarArbitroPartido(int idArbitro,int idPartido) {
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement(SqlAdminFutSal.ADD_REFEREE_TO_MATCH);
            int count = 1;
            if(idArbitro==0){
    ...
    public void eliminar(Partido cam) {
        ...
        try{
            cx = DaoUtil.ConectionDriveDB();
            stmt = cx.prepareStatement("DELETE FROM partido  WHERE idPartido = ?");
