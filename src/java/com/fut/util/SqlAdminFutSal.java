...
public class SqlAdminFutSal {
    ...
    /*DAO GRUPO*/
    public static final String INSERT_GRUP = "INSERT INTO public.grupo (\"nombreGrupo\",\"idCampeonato\",\"idUsuario\") values(?,?,?)";
    public static final String UPDATE_GRUP = "UPDATE public.grupo SET \"nombreGrupo\" = ? WHERE \"idGrupo\" = ?";
